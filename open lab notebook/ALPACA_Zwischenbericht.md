...
Die nächsten Schritte beinhalten die weitere Arbeit an den Analyseskripten (soweit möglich ohne neu akquirierte Daten), sowie der Beginn der Automatisierung der bestehenden pipelines. Weiterhin wird mit der Einarbeitung in die Erstellung und Anwendung von docker containers begonnen und die tutorials für verschiedene Bereiche der toolbox 
...
Im Fall von terminlichen und/oder technisch relatierten Problemen bestehen aber auch andere Möglichkeiten der Kommunikation und Planung, so das ich Daniel immer erreichen und Unterstützung bekommen kann. 
...
ich sehr von der bereits angesprochenen Diversität und aktiven Gruppe, da der Austausch mit fachfremden Personen ein völlig neue und andere Sicht auf das Projekt ermöglicht und Verbesserungschancen aufzeigt. Des Weiteren ist auch ein 
...
innerhalb derer man das Gefühl hat Teil von etwas Größerem zu sein. Etwas was hoffentlich über die Zeit des Programms und darüber hinaus bestehen bleibt.
...
kann. Beispiele hierfür sind unter anderem das Durchführen gemeinsamer Aktionen (z.B. hackathons) und Kollaborationen. Mehr Vernetzung und Zusammenarbeit würde ich mir mit VertreterInnen von Wikimedia wünschen, vor allem hinsichtlich Unterstützung 
