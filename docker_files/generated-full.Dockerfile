...
#-------------------------
RUN conda create -y -q --name alpaca --channel vida-nyu python=3.6 \
                                                        numpy \
                                                        pandas \
                                                        traits \
                                                        jupyter \
...
#-------------------------
RUN /bin/bash -c "source activate alpaca \
...
RUN echo '{ \
    ...
    \n    ] \
    \n  ], \
    \n  "generation_timestamp": "2018-01-14 17:16:14", \
